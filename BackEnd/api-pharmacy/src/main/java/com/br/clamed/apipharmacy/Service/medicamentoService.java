...
import com.br.clamed.apipharmacy.Repository.medicamentoRepository;
...
public class medicamentoService {
    ...
    public ResponseEntity<?> cadastrarMedicamento(@Valid @RequestBody medicamentoEntity medicamento) {
        ...
        if(validarMedicamento(medicamento)){
            ...
            return new ResponseEntity<>(new Error(Response.SC_BAD_REQUEST,"Erro!", HttpStatus.CONFLICT,"Verifique se foram preenchidos os campos: nome_medicamento, nome_laboratorio e dosagem"),HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> listarMedicamentos() {
        ...
        if (listamedicamentos.isEmpty()) {
            return new ResponseEntity<>(new Error(Response.SC_NOT_FOUND, "Erro!", HttpStatus.NOT_FOUND, "Não existem medicamentos cadastrados"), HttpStatus.NOT_FOUND);
        } else {
    ...
    public ResponseEntity<?> buscarMedicamentoporID(@PathVariable Long id) {
        ...
        if (medicamentoRepository.existsById(id)) {
            ...
            return new ResponseEntity<>(new Error(Response.SC_NOT_FOUND, "Erro!", HttpStatus.NOT_FOUND, "Não existe medicamento com o id: " + id), HttpStatus.NOT_FOUND);
        }
    }
